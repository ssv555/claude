...
### Business changes
<Что изменилось с точки зрения пользователя / бизнес-логики, конкретно, без техжаргона.
Например: «Добавлена возможность сброса пароля по email».
Если изменение чисто техническое (рефакторинг, тест, инфра) — «Техническое: <суть>».>
